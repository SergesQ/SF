...
def help(message: telebot.types.Message):
    text = 'Чтобы начать работу введи в одну строку команду боту в формате:\n<имя валюты>\n \
...
def convert(message: telebot.types.Message):
    try:
        ...
        if len(values) != 3:
            raise ConvertionException('Введено слишком много символов')
        ...
        bot.reply_to(message, f'Ошибка! Не удалось обработать команду\n{e}')
    else:
